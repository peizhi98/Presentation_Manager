...
//        SpringApplication.run(PresentationManagerApplication.class, args);
        ...
        System.out.println("Fitness: " + population.getScheduleList().get(0).getFitness()
        ...
        for (int i = 0; i < population.getScheduleList().size(); i++) {
            ...
            System.out.println("Schedule " + i + ": fitness = " + currentSchedule.getFitness() + "conflicts = " + currentSchedule.getNumberOfConflict());
        ...
        while (population.getScheduleList().get(0).getFitness() != 1.0) {
        ...
        System.out.println("Schedule " + 0 + ": fitness = " + currentSchedule.getFitness() + "conflicts = " + currentSchedule.getNumberOfConflict());
        for (Presentation presentation : currentSchedule.getPresentationList()) {
            System.out.println(presentation.getStartTime() + " to " + presentation.getEndTime());
        }
...
//            System.out.println(population.getScheduleList().indexOf(geneticAlgorithm.selectRandomlyBasedOnFitness(population)));
//        });
    }
