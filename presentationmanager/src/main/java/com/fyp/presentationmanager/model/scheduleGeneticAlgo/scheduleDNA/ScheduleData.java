...
public class ScheduleData {
    private List<Room> roomsWithMeetingSlots;
    private List<Presentation> presentations;
//    private List<Room> roomList;
    private Room onlineRoom;
...
//        this.initTestData();
    ...
    public ScheduleData(List<Room> rooms, List<Presentation> presentationsToSchedule,Room onlineRoom) {
        this.roomsWithMeetingSlots = rooms;
        this.presentations = presentationsToSchedule;
