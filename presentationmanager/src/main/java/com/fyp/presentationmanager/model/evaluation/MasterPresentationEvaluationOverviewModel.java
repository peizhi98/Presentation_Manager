...
@Getter
@Setter
public class MasterPresentationEvaluationOverviewModel {
    ...
    private BigDecimal avgPanelEvaluationScore;
    private BigDecimal total;
    private BigDecimal totalInPercent;

    public void calculateTotal(Integer totalWeightage) {
        if (avgPanelEvaluationScore != null && totalWeightage != null) {
...
//            total = new BigDecimal(reportScore.add(presentationScore).toString());
            this.total = new BigDecimal(avgPanelEvaluationScore.toString());
